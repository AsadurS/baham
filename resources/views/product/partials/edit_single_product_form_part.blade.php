...
<div class="col-sm-12"><br>
    ...
    <table class="table table-bordered add-product-price-table table-condensed {{$class}}">
        <tr>
          ...
          <th>@lang('product.whole_selling_price')</th>
            ...
            @if($loop->first)
                <tr>
                    ...
                    <td>
                        ...
                        {!! Form::text('single_wsp',  @num_format($variation->default_whole_sell_price), ['class' => 'form-control input-sm dsp input_number', 'placeholder' => __('product.exc_of_tax'), 'id' => 'single_wsp', 'required']); !!}

                        {!! Form::text('single_wsp_inc_tax',  @num_format($variation->whole_sell_price_inc_tax), ['class' => 'form-control input-sm hide input_number', 'placeholder' => __('product.inc_of_tax'), 'id' => 'single_wsp_inc_tax', 'required']); !!}
                    </td>
                    <td>
                        @php
