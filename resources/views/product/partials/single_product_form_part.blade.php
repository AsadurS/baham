    ...
    <table class="table table-bordered add-product-price-table table-condensed {{$class}}">
        ...
        <tr>
          ...
          <td>
            ...
            <td>
            <label><span class="dsp_label">@lang('product.exc_of_tax')</span></label>
            {!! Form::text('single_wsp', $default, ['class' => 'form-control input-sm dsp input_number', 'placeholder' => __('product.exc_of_tax'), 'id' => 'single_wsp', 'required']); !!}

            {!! Form::text('single_wsp_inc_tax', $default, ['class' => 'form-control input-sm hide input_number', 'placeholder' => __('product.inc_of_tax'), 'id' => 'single_wsp_inc_tax', 'required']); !!}
          </td>
          @if(empty($quick_add))
          <td>
