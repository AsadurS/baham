...
class ProductController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($product->type == 'single') {
                $single_data = $request->only(['single_variation_id', 'single_dpp', 'single_dpp_inc_tax', 'single_dsp_inc_tax', 'profit_percent', 'single_dsp', 'single_wsp', 'single_wsp_inc_tax']);
                ...
                $variation->default_whole_sell_price = $this->productUtil->num_uf($single_data['single_wsp']);
                $variation->whole_sell_price_inc_tax = $this->productUtil->num_uf($single_data['single_wsp_inc_tax']);
                $variation->save();
